subroutine scheme_weno5z_general
use flow_general
implicit none
integer :: index_block,index_i,index_j,index_eq

do index_block=1,num_block
	call scheme_weno5z_xip(block_grid(index_block)%flux_xip, &
	...
	call scheme_weno5z_xin(block_grid(index_block)%flux_xin, &
						   block_grid(index_block)%ni,       &
						   block_grid(index_block)%nj,       &
						   block_grid(index_block)%bfsize_i, &
						   block_grid(index_block)%bfsize_j, &
	...
	call scheme_weno5z_etap(block_grid(index_block)%flux_etap, &
						   block_grid(index_block)%ni,       &
						   block_grid(index_block)%nj,       &
						   block_grid(index_block)%bfsize_i, &
						   block_grid(index_block)%bfsize_j, &
	...
	call scheme_weno5z_etan(block_grid(index_block)%flux_etan, &
						   block_grid(index_block)%ni,       &
						   block_grid(index_block)%nj,       &
						   block_grid(index_block)%bfsize_i, &
						   block_grid(index_block)%bfsize_j, &
...
enddo
end subroutine scheme_weno5z_general

subroutine scheme_weno5z_xip(flux_xip,ni,nj,bfsize_i,bfsize_j,neq,h_xip)
use weno
implicit none
...
do index_j=1,nj
	do index_i=1,ni+1
        ...
        enddo
		call weno5z_stencil(lf,h_xip(index_i,index_j,index_eq))
	enddo
enddo
!$OMP end PARALLEL DO
enddo
...
subroutine scheme_weno5z_xin(flux_xin,ni,nj,bfsize_i,bfsize_j,neq,h_xin)
use weno
implicit none
integer,intent(in) :: ni,nj,bfsize_i,bfsize_j,neq
...
do index_j=1,nj
	do index_i=1,ni+1
        ...
        enddo
		call weno5z_stencil(lf,h_xin(index_i,index_j,index_eq))
	enddo
enddo
!$OMP end PARALLEL DO
enddo
...
subroutine scheme_weno5z_etap(flux_etap,ni,nj,bfsize_i,bfsize_j,neq,h_etap)
use weno
implicit none
integer,intent(in) :: ni,nj,bfsize_i,bfsize_j,neq
...
do index_i=1,ni
	do index_j=1,nj+1
        ...
        enddo
		call weno5z_stencil(lf,h_etap(index_j,index_i,index_eq))
	enddo
enddo
!$OMP end PARALLEL DO
enddo
...
subroutine scheme_weno5z_etan(flux_etan,ni,nj,bfsize_i,bfsize_j,neq,h_etan)
use weno
implicit none
integer,intent(in) :: ni,nj,bfsize_i,bfsize_j,neq
...
do index_i=1,ni
	do index_j=1,nj+1
		...
		call weno5z_stencil(lf,h_etan(index_j,index_i,index_eq))
	enddo
enddo
!$OMP end PARALLEL DO
enddo
